System.register(["./application.6e7dd.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_application6e7ddJs) {
      createApplication = _application6e7ddJs.createApplication;
    }],
    execute: function () {
